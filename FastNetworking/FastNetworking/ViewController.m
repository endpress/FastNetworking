...
- (void)viewDidLoad {
    ...
    [[FNHttpSessionManager manager] sendURLString:@"http://bbs.che-by.com/api/section" withMethod:nil parameters:parameters completionHandler:^(NSURLResponse *responce, id responceObject, NSError *error) {
